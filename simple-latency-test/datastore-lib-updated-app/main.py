...
print(f"Container Datastore-Lib-Updated started! Initialization datetime: {app_init_ready_dt}", flush=True)

print(f"Container Datastore-Lib-Updated started! Initialization completed in {app_initialization_ms} ms.", flush=True)
